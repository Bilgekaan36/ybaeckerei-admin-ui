...
export const BillboardForm: React.FC<BillboardFormProps> = ({
  ...
  const onSubmit = async (data: BillboardFormValues) => {
    try {
      ...
      if (initialData) {
        await axios.post(
          `${process.env.NEXT_PUBLIC_COMMANDS_SERVICE_API_URL}/administration/editBillboard`,
          {
            billboardId: params.billboardId,
            billboardTitle: data.billboardTitle,
            billboardImageUrl: data.billboardImageUrl,
          }
        );
      } else {
        await axios.post(
          `${process.env.NEXT_PUBLIC_COMMANDS_SERVICE_API_URL}/registration/register-billboard`,
          data
        );
      }
